		...
		for (int i = 0; i < world.players.size(); ++i) {
			...
			if (!player.isInvulnerable() && player.isAlive()) {
				...
				if (entity instanceof EntityHorse
						...
						&& (((EntityHorse) entity).getOwnerUUID().equals(player.getUniqueID().toString()) || MyZ.instance.isFriend(
								MyZ.instance.getUID(((EntityHorse) entity).getOwnerUUID()), player.getUniqueID())))
					continue;
