	...
	class EntitySelectorNearestAttackableHorseTarget implements IEntitySelector {
		...
		public boolean a(Entity entity) {
			...
			if (e.creature.getOwnerUUID() != null && !e.creature.getOwnerUUID().isEmpty()) {
				if (!MyZ.instance.isBandit(MyZ.instance.getUID(e.creature.getOwnerUUID())))
					return false;
				if (entity instanceof EntityHuman)
					if (e.creature.getOwnerUUID().equals(((EntityHuman) entity).getName())
							|| MyZ.instance.isFriend(MyZ.instance.getUID(e.creature.getOwnerUUID()),
