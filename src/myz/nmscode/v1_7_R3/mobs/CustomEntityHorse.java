...
public class CustomEntityHorse extends EntityHorse implements CustomMob {
	...
	public EntityLiving getGoalTarget() {
		...
		if (this.getOwnerUUID() == null || this.getOwnerUUID().isEmpty())
			return null;

		if (!MyZ.instance.isBandit(UUID.fromString(getOwnerUUID())))
			return null;
		return super.getGoalTarget();
	}
	...
	protected Entity findTarget() {
		if ((this.getOwnerUUID() == null || this.getOwnerUUID().isEmpty()) && ((Horse) getBukkitEntity()).getVariant() != Variant.UNDEAD_HORSE
				&& ((Horse) getBukkitEntity()).getVariant() != Variant.SKELETON_HORSE)
			return null;
